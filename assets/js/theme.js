...
$(window).on('load', function() {
    /*------- Preloader (fallback hide once everything is loaded) --------*/
...
$(function() {
    ...
    /*------- Preloader: hide quickly on DOM ready so the page opens fast --------*/
    setTimeout(function() {
        $('#preloader').fadeOut(150);
    }, 200);

    // --------------------------- Sticky Header ------------------------ //
    // Handled with pure CSS (position: sticky) for smooth, jump-free behaviour.
    // The old jquery.sticky plugin caused the navbar to flicker/disappear on scroll.
